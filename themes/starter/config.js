...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '“佚名”不是缺失，而是一种让每位居住者都能成为空间创造者的可能', // 英雄区文字
  STARTER_HERO_TITLE_2: 'Anonymity in design voids authorship, empowering occupants as co-creators.', // 英雄区文字
