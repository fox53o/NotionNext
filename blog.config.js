...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '佚名建筑', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '建筑|空间｜装置', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.findme-arch.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '建筑设计, 佚名', // 网站关键词 英文逗号隔开
